...
dfClimateFinalArea$cropland1 <- ((dfClimateFinalArea$areaHA/dfClimateFinalArea$areaTot)*dfClimateFinalArea$cropland1970AD)
dfClimateFinalArea$cropland2 <- ((dfClimateFinalArea$areaHA/dfClimateFinalArea$areaTot)*dfClimateFinalArea$cropland1980AD)
dfClimateFinalArea$cropland3 <- ((dfClimateFinalArea$areaHA/dfClimateFinalArea$areaTot)*dfClimateFinalArea$cropland1990AD)
dfClimateFinalArea$cropland4 <- ((dfClimateFinalArea$areaHA/dfClimateFinalArea$areaTot)*dfClimateFinalArea$cropland2000AD)
dfClimateFinalArea$cropland5 <- ((dfClimateFinalArea$areaHA/dfClimateFinalArea$areaTot)*dfClimateFinalArea$cropland2010AD)

# get total cropland by region
sum(is.na(dfClimateFinalArea))
dfCroplandTot <- aggregate(cbind(cropland1,cropland2,cropland3,cropland4,cropland5)~Area,dfClimateFinalArea,sum)
head(dfCroplandTot)
...
dfClimateFinalArea$weight1 <- dfClimateFinalArea$cropland1/dfClimateFinalArea$cropland1Tot
dfClimateFinalArea$weight2 <- dfClimateFinalArea$cropland2/dfClimateFinalArea$cropland2Tot
dfClimateFinalArea$weight3 <- dfClimateFinalArea$cropland3/dfClimateFinalArea$cropland3Tot
dfClimateFinalArea$weight4 <- dfClimateFinalArea$cropland4/dfClimateFinalArea$cropland4Tot
dfClimateFinalArea$weight5 <- dfClimateFinalArea$cropland5/dfClimateFinalArea$cropland5Tot
max(c(dfClimateFinalArea$weight1,dfClimateFinalArea$weight2,dfClimateFinalArea$weight3,dfClimateFinalArea$weight4,dfClimateFinalArea$weight5),na.rm=T)
which(dfClimateFinalArea$weight1==1)
dfClimateFinalArea[40334,]
...
## omit NA
dfAll <- na.omit(dfAll)
length(unique(dfAll$Level)) ## 135 countries
