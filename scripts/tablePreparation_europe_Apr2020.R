...
dfClimateFinalArea$cropland1 <- ((dfClimateFinalArea$areaHA/dfClimateFinalArea$areaTot)*dfClimateFinalArea$cropland1980AD)
dfClimateFinalArea$cropland2 <- ((dfClimateFinalArea$areaHA/dfClimateFinalArea$areaTot)*dfClimateFinalArea$cropland1990AD)
dfClimateFinalArea$cropland3 <- ((dfClimateFinalArea$areaHA/dfClimateFinalArea$areaTot)*dfClimateFinalArea$cropland2000AD)
dfClimateFinalArea$cropland4 <- ((dfClimateFinalArea$areaHA/dfClimateFinalArea$areaTot)*dfClimateFinalArea$cropland2010AD)

# get cropland by region
sum(is.na(dfClimateFinalArea))
dfCroplandTot <- aggregate(cbind(cropland1,cropland2,cropland3,cropland4)~NUTS_ID,dfClimateFinalArea,sum)
head(dfCroplandTot)
...
## omit NA
dfAll <- na.omit(dfAll)
length(unique(dfAll$Level)) ## 162 regions
nrow(dfAll) ## 377 data points
